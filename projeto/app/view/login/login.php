...
<div class="container" style="margin-top: 5%; font-family: 'Poppins', sans-serif;">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center">
            ...
            <form id="frmLogin" action="./LoginController.php?action=logon" method="POST" class="mt-4">
                <div class="form-group mb-4">
                    <label for="txtLogin" style="font-weight: bold; color: #333;">E-mail ou Nome de Usuário</label>
                ...
                <div class="form-group mb-4">
                    ...
                    <small class="form-text text-muted mt-2">
                        <a href="#" style="text-decoration: none; color: #C30E59; font-weight: bold;">Esqueci minha senha</a>
                    </small>
                </div>
        ...
        <div class="col-md-6 text-center d-none d-md-block">
            <img src="<?= BASEURL ?>/view/img/LOGIN.png" alt="Doces deliciosos" class="img-fluid"
