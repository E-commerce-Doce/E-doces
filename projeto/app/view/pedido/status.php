...
<div class="container my-5">
    <h2 class="ml-5 mb-5" style="font-family: caveat; color: #C30E59;">Status do Pedido</h2>
            ...
            <div class="info">
                <ul>
                    <p class="info-item">
                        ...
                        <strong>Cancelado?</strong> Se seu pedido foi cancelado e você escolheu o PIX, entre em contato com nosso e-mail <strong>ameis.contato@gmail.com</strong> para reembolso.
                    </p>
                    ...
                    <p class="info-item">
                        ...
                        <strong>Finalizado?</strong> Quando seu pedido for finalizado, não se esqueça de avaliar nossos confeiteiros! Isso ajuda a melhorar sempre a qualidade dos nossos serviços. 💖
                    </p>
                </ul>
            </div>
        </div>
