    ...
    <ul class="list-group m-3">
        ...
        ?>
                <li class="list-group-item mb-3">
                    ...
                    <?php if ($pedido->getStatus() != Status::CANCELADO && $pedido->getStatus() != Status::ENTREGUE): ?>
                ...
                <p><strong>Nome do Comprovante:</strong>
                    <span><?= $pedido->getNomeComprovante() ? $pedido->getNomeComprovante() : 'Não informado'; ?></span>
                </p>
                <p><strong>Comprovante:</strong><br>
                    <?php if ($pedido->getComprovante()): ?>
                        <img src="<?= URL_ARQUIVOS . "/" . $pedido->getComprovante(); ?>" class="card-img-top" alt="Imagem do comprovante" style="height: 300px; width:100%; object-fit: cover;">
                    <?php else: ?>
...
<div class="m-5">
    ...
    <div class="row" style="margin-top: 20px; font-family: montserrat;">
        <div class="col-md-3 mb-4">
            <h4 class="mb-3 ml-4 text-black">Recebidos</h4>
            <?php exibirListaPedidos([Status::RECEBIDO], $dados); ?>
        </div>
        <div class="col-md-3 mb-3">
            <h4 class="mb-3 ml-4 text-black">Em Andamento</h4>
            <?php exibirListaPedidos([Status::PREPARANDO, Status::PRONTO], $dados); ?>
        </div>
        <div class="col-md-3 mb-3">
            <h4 class="mb-3 ml-4 text-black">Finalizados</h4>
            <?php exibirListaPedidos([Status::ENTREGUE], $dados); ?>
        </div>
        <div class="col-md-3 mb-3">
            <h4 class="mb-3 ml-4 text-black">Cancelados</h4>
            <?php exibirListaPedidos([Status::CANCELADO], $dados); ?>
        </div>
    </div>
</div>
