...
<div class="container my-5">
    ...
    <div class="row m-5">
        ...
        <button class="btn btn-secondary ml-auto" onclick="window.location.href='<?= BASEURL ?>/controller/AvaliacaoController.php?action=list&nomeLoja=<?= urlencode($dados['lista'][0]->getConfeiteiro()->getNomeLoja()); ?>'">
            Ver Avaliações
        </button>
    </div>
