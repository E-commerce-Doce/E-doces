...
<style>
    @media (max-width: 991px) {
        ...
        .sair-btn {
            display: block;
            /* Garante que o botão ocupe a largura total */
            width: 100%;
            /* Faz o botão ocupar 100% da largura */
            text-align: center;
            /* Centraliza o texto dentro do botão */
            padding: 10px 0;
            /* Ajusta o padding para o botão ficar mais espaçado */
        }
    }
</style>
...
<nav class="navbar navbar-expand-lg" style="background-color:#C30E59;">
    ...
    <button class="navbar-toggler" style="background-color: #FFE2E2; color:#C30E59;" type="button" data-toggle="collapse" data-target="#conteudoNavbarSuportado" aria-controls="conteudoNavbarSuportado" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
        <ul class="navbar-nav ml-auto" style="font-family: montserrat; font-weight:320;">
            ...
            <?php if ($nome !== "(Sessão expirada)"): ?>
                ...
                <li class="nav-item active">
                    <a class="btn nav-link d-block w-100 text-center" style="background-color: #FFE2E2; color:#C30E59;" href="<?= LOGOUT_PAGE ?>">Sair</a>
                </li>
            <?php endif; ?>
        </ul>
    </div>
