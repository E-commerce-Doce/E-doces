...
<nav class="navbar navbar-expand-lg" style="color:#EA4961;">
    <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
        ...
        <ul class="navbar-nav ml-auto" style="font-family: montserrat; font-weight:320; ">
            ...
            <?php elseif ($usuarioPapel === UsuarioPapel::CONFEITEIRO): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASEURL . '/controller/ConfeiteiroController.php?action=listPedidos' ?>">Pedidos Realizados&nbsp;</a>
                </li>
            ...
            <?php elseif ($usuarioPapel === UsuarioPapel::CLIENTE): ?>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<?= BASEURL . '/controller/PedidoController.php?action=listPedidos' ?>"> Meus Pedidos &nbsp;</a>
                </li> 

                <li class="nav-item">
                    <a class="nav-link" href="<?= BASEURL . '/controller/CarrinhoController.php?action=listCarrinho' ?>">
