...
<nav class="navbar navbar-expand-lg">
    <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/controller/DoceController.php?action=list' ?>">Doces&nbsp;</a>
            </li>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/controller/UsuarioController.php?action=create' ?>">Cadastra-se</a>
            </li> -->
            <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
