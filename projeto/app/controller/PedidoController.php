...
class PedidoController extends Controller
{
    ...
    protected function realizarPagamento()
    {
        ...
        $dados['idPedido'] = isset($_GET['idPedido']) ? (int)$_GET['idPedido'] : 0;
        ...
        if (empty($erros)) {
            try {
                ...
                header("Location: " . BASEURL . "/controller/PedidoController.php?action=acompanhaStatus&idPedido=" .  $dados['idPedido']);
                exit;
            } catch (PDOException $e) {
    ...
    protected function acompanharStatus()
    {
        ...
        if (isset($_GET['idPedido'])) { $pedidoId = $_GET['idPedido'];
