...
class DoceDAO
{
    ...
    public function insert(Doce $doce)
    {
        $conn = Connection::getConn();

        $sql = "INSERT INTO Doce (nomeDoce, descricao, caminhoImagem, valor, ingredientes, idConfeiteiro, idTipoDoce)" .
            " VALUES (:nomeDoce, :descricao, :caminhoImagem,:valor,:ingredientes,:idConfeiteiro,:idTipoDoce)";
        ...
        $stm->bindValue('idConfeiteiro', $doce->getConfeiteiro()->getIdConfeiteiro());
