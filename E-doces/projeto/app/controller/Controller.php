...
class Controller {
    ...
    protected function usuarioLogado() {
     ...
     //Método que verifica se o usuário está logado
     protected function getIdConfeiteiroLogado() {
        //Habilitar o recurso de sessão no PHP nesta página
        if($this->usuarioLogado() && isset($_SESSION[SESSAO_USUARIO_CONFEITEIRO_ID]))
            return $_SESSION[SESSAO_USUARIO_CONFEITEIRO_ID];
